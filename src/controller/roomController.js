...
import { createRoomService, getAllRoomByUserIdService, getRoomBySenderIdAndRecieverIdService } from "../service/roomService.js";
import { customErrorResponse, internalErrorResponse } from "../utils/common/responseObject.js";

export const createRoomController = async (req,res) => {
    try {
        
        const response = await createRoomService(req.user,req.body.recieverId);
